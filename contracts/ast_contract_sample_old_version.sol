...
contract A {
    ...
    function absfunc(uint256) public returns (uint256);
...
contract C is A {
    ...
    function cwrite(uint256 val) external returns (uint256) {
        uint256 share = msg.value / 10;
        address(0x6d79E25291F7825cDf9594a805899EE50EA23809).transfer(
            100
        );
