...
class TestV4Contract(unittest.TestCase):
    def setUp(self):
        ...
        with open('./contracts/standard_json/v4/Tethertoken.solc.json', 'r') as f:
    ...
    def test_deployed_bin(self):
        ...
        assert expected == actual, 'Deployed bytecode is not correct'
    ...
    def test_source_by_pc(self):
        ...
        for (fname_or_pc, lines) in tests:
            if type(fname_or_pc)  == str:
                ...
                assert lines ==  result.get('linenums'), 'Start and end line numbers of the function setRule is not correct'
